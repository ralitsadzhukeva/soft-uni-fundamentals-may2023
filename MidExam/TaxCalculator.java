            ...
            switch (type) {
                case "family":
                    ...
                    if (kilometers % 3000 == 0) {
                        ...
                        int extraKilometers = kilometers % 3000;
                        tax = initialTax + 12 * (kilometers / 3000) + 12 * (extraKilometers / 3000) - 5 * taxYears;
                    }
                    break;
                case "heavyDuty":
                    initialTax = 80.0;
                ...
                case "sports":
                    ...
                    if (kilometers % 2000 == 0) {
                        ...
                        int extraKilometers = kilometers % 2000;
                        tax = initialTax - 9 * taxYears + 18 * (kilometers / 2000) + 18 * (extraKilometers / 2000);
                    }
                    break;
                default:
